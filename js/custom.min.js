...
function allSliders() {
  ...
  var meatSlider = new Swiper(".meatSlider", {
    loop: true,
    slidesPerView: 4,
    spaceBetween: 20,
  ...
  var testinomalSlider2 = new Swiper(".testinomalSlider2", {
    spaceBetween: 10,
    slidesPerView: 3,
    freeMode: true,
  ...
  var testinomalSlider1 = new Swiper(".testinomalSlider1", {
    spaceBetween: 0,
    slidesPerView: 1,
    loop: true,
    centeredSlides:true,
